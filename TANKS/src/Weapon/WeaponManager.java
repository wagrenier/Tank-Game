...
public class WeaponManager {
    ...
    public void setupWeaponManager(){
       ...
       //Repair kits
       itemArrayList.add(new RepairItem("Repair (S)", 50, "Texture/Items/Special/Small Repair Kit.png", 25));
       itemArrayList.add(new RepairItem("Repair (M)", 75, "Texture/Items/Special/Medium Repair Kit.png", 50));
       itemArrayList.add(new RepairItem("Repair (L)", 100, "Texture/Items/Special/Large Repair Kit.png", 75));
       
       //Shields
       itemArrayList.add(new ShieldItem("Shield (S)", 100, "Texture/Items/Special/Small Shield.png", 25));
       itemArrayList.add(new ShieldItem("Shield (M)", 150, "Texture/Items/Special/Medium Shield.png", 50));
       itemArrayList.add(new ShieldItem("Shield (L)", 200, "Texture/Items/Special/Large Shield.png", 75));
       
       //Upgrades
       itemArrayList.add(new UpgradeItem("Armor", 200, "Texture/Items/Special/Armor Upgrade.png", 5));
       itemArrayList.add(new UpgradeItem("Engine", 200, "Texture/Items/Special/Engine Upgrade.png", 10));
